...
public class VdorRandomViolence
{
    readonly Observation observation;

    internal VdorRandomViolence(Observation observation)
    {
    ...
    public static Observation Create()
    {
        ...
        observation.Code = VdorCustomCs.RandomViolence;

        observation.VdorRandomViolence().AddProfile();

        return observation;
    }

    public const string ProfileUrl = "http://hl7.org/fhir/us/vdor/StructureDefinition/vdor-random-violence";

    /// <summary>
    /// Set profile for the Vdor Random Violence
    /// </summary>
    ...
    /// <summary>
    /// Clear profile for the Vdor Random Violence
    /// </summary>
    ...
    public CodeableConcept? ValueOfRandomViolence
    {
