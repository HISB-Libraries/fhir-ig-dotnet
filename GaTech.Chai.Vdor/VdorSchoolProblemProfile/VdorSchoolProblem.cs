...
public class VdorSchoolProblem
{
    readonly Observation observation;

    internal VdorSchoolProblem(Observation observation)
    {
    ...
    public static Observation Create()
    {
        ...
        observation.Code = VdorCustomCs.SchoolProblem;
        observation.VdorSchoolProblem().AddProfile();

        return observation;
    }

    public const string ProfileUrl = "http://hl7.org/fhir/us/vdor/StructureDefinition/vdor-school-problem";
    ...
    public CodeableConcept? ValueOfSchoolProblem
    {
