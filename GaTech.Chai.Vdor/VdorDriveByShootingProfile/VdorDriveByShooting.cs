...
public class VdorDriveByShooting
{
    readonly Observation observation;

    internal VdorDriveByShooting(Observation observation)
    {
    ...
    public static Observation Create()
    {
        ...
        observation.Code = VdorCustomCs.DriveByShooting;

        observation.VdorDriveByShooting().AddProfile();

        return observation;
    }

    public const string ProfileUrl = "http://hl7.org/fhir/us/vdor/StructureDefinition/vdor-drive-by-shooting";
    ...
    public CodeableConcept? ValueOfDriveByShooting
    {
