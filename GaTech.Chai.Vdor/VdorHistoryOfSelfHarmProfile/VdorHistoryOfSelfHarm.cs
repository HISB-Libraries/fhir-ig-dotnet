...
public class VdorHistoryOfSelfHarm
{
    readonly Observation observation;

    internal VdorHistoryOfSelfHarm(Observation observation)
    {
    ...
    public static Observation Create()
    {
        ...
        observation.Code = VdorCustomCs.SelfHarm;

        observation.VdorHistoryOfSelfHarm().AddProfile();

        return observation;
    }

    public const string ProfileUrl = "http://hl7.org/fhir/us/vdor/StructureDefinition/vdor-history-of-self-harm";
    ...
    public CodeableConcept? ValueOfSelfHarm
    {
