...
public class VdorCurrentDepressedMood
{
    readonly Observation observation;

    internal VdorCurrentDepressedMood(Observation observation)
    {
    ...
    public static Observation Create()
    {
        ...
        observation.Code = VdorCustomCs.CurrentDepressedMood;
        observation.VdorCurrentDepressedMood().AddProfile();
        
        return observation;
    }

    public const string ProfileUrl = "http://hl7.org/fhir/us/vdor/StructureDefinition/vdor-current-depressed-mood";
 ...
 /// <summary>
    ...
    public CodeableConcept? ValueOfCurrentDepressedMood
    {
