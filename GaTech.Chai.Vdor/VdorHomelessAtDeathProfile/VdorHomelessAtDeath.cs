...
public class VdorHomelessAtDeath
{
    readonly Observation observation;

    internal VdorHomelessAtDeath(Observation observation)
    {
    ...
    {
        Observation observation = VdorDemographicsSocialHistory.Create();
        observation.VdorDemographics().RemoveProfile();
        observation.Code = VdorCustomCs.HomelessAtDeath;

        observation.VdorHomelessAtDeath().AddProfile();

        return observation;
    }

    public const string ProfileUrl = "http://hl7.org/fhir/us/vdor/StructureDefinition/vdor-homeless-at-death";
    ...
    public CodeableConcept? ValueOfHomelessAtDeath
    {
