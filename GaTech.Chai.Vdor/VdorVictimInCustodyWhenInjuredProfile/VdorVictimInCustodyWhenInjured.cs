...
public class VdorVictimInCustodyWhenInjured
{
    readonly Observation observation;

    internal VdorVictimInCustodyWhenInjured(Observation observation)
    {
    ...
    public static Observation Create()
    {
        ...
        observation.Code = VdorCustomCs.VictimInCustodyWhenInjured;

        observation.VdorVictimInCustodyWhenInjured().AddProfile();

        return observation;
    }

    public const string ProfileUrl = "http://hl7.org/fhir/us/vdor/StructureDefinition/vdor-victim-in-custody-when-injured";

    /// <summary>
    /// Set profile for the Vdor Victim In Custody When Injured
    /// </summary>
    ...
    /// <summary>
    /// Clear profile for the Vdor Victim In Custody When Injured
    /// </summary>
    ...
    public CodeableConcept? ValueOfVictimInCustodyWhenInjured
    {
