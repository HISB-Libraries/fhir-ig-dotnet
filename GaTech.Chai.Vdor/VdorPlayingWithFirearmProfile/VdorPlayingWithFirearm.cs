...
public class VdorPlayingWithFirearm
{
    readonly Observation observation;

    internal VdorPlayingWithFirearm(Observation observation)
    {
    ...
    public static Observation Create()
    {
        ...
        observation.Code = VdorCustomCs.PlayWithFirearm;
        observation.VdorPlayingWithFirearm().AddProfile();

        return observation;
    }

    public const string ProfileUrl = "http://hl7.org/fhir/us/vdor/StructureDefinition/vdor-playing-with-firearm";
    ...
    public CodeableConcept? ValueOfPlayingWithFirearm
    {
