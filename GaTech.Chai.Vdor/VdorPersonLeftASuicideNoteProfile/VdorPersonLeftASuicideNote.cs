...
public class VdorPersonLeftASuicideNote
{
    readonly Observation observation;

    internal VdorPersonLeftASuicideNote(Observation observation)
    {
    ...
    public static Observation Create()
    {
        ...
        observation.Code = VdorCustomCs.PersonLeftASuicideNote;
        observation.VdorPersonLeftASuicideNote().AddProfile();

        return observation;
    }

    public const string ProfileUrl = "http://hl7.org/fhir/us/vdor/StructureDefinition/vdor-person-left-a-suicide-note";

    /// <summary>
    /// Set profile for the Vdor School Problem
    /// </summary>
    ...
    public CodeableConcept? ValueOfPersonLeftASuicideNote
    {
