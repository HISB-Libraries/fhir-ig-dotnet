...
/// <summary>
/// </summary>
public class NvdrsDocumentBundle
{
    readonly Bundle bundle;

    internal NvdrsDocumentBundle(Bundle bundle)
    {
        this.bundle = bundle;
    }
    ...
    {
        Bundle bundle = new();
        bundle.NvdrsDocumentBundle().AddFixedValues();
        bundle.NvdrsDocumentBundle().AddProfile();
    ...
    {
        Bundle bundle = new();
        bundle.NvdrsDocumentBundle().NVDRSComposition = composition ?? throw new Exception("Composition cannot be null for MDIandEdrs Bundle entry[0].");
        bundle.NvdrsDocumentBundle().AddProfile();
        bundle.NvdrsDocumentBundle().AddFixedValues();
    ...
    public Composition? NVDRSComposition
    {
        ...
        set
        {
            ...
            if (!value.hasProfile(NvdrsComposition.ProfileUrl))
            {
