...
public class NvdrsSuspects
{
    readonly Observation observation;

    internal NvdrsSuspects(Observation observation)
    {
    ...
    public static Observation Create()
    {
        ...
        {
            Category = new List<CodeableConcept>() { NvdrsCustomCs.Suspects }
        };

        observation.NvdrsSuspects().AddProfile();
