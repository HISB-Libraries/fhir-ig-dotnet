...
namespace GaTech.Chai.Mdi.Common
{
    ...
    {
        public static CodeableConcept AdditionalDemographics = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "demographics", "Demographics Section", null);
        public static CodeableConcept Circumstances = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "circumstances", "Circumstances of the Death Section", null);
        public static CodeableConcept Jurisdiction = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "jurisdiction", "Jurisdiction Section", null);
        public static CodeableConcept CauseManner = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "cause-manner", "Cause and Manner of Death Section", null);
        public static CodeableConcept MedicalHistory = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "medical-history", "Medical History Section", null);
        public static CodeableConcept ExamAutopsy = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "exam-autopsy", "Exam/Autopsy Section", null);
        public static CodeableConcept MdiCaseNumber = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "mdi-case-number", "MDI Case Number", null);
        public static CodeableConcept EdrsFileNumber = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "edrs-file-number", "EDRS File Number", null);
        public static CodeableConcept ToxLabCaseNumber = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "tox-lab-case-number", "Toxicology Laboratory Case Number", null);
        public static CodeableConcept MdiCaseNotesSummary = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "mdi-case-notes-summary", "MDI Case Notes Summary", null);
        public static CodeableConcept MdiCaseHistory = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "mdi-case-history", "MDI Case History", null);
        public static CodeableConcept ToxResultReport = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "tox-result-report", "Toxicology Lab Results", null);
        public static CodeableConcept Narratives = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", "narratives", "Narratives", null);
        ...
        public static CodeableConcept Injury = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", " injury", "Injury Location", null);
        public static CodeableConcept Death = new ("http://hl7.org/fhir/us/mdi/CodeSystem/CodeSystem-mdi-codes", " death", "Death Location", null);
    }
